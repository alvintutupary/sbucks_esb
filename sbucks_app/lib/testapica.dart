...
class TestaPica extends StatefulWidget {
  TestaPica({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _TestaPicaState createState() => new _TestaPicaState();
}
...
class _TestaPicaState extends State<TestaPica> {
  @override
