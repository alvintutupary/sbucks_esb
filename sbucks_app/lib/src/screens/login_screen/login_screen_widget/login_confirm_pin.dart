...
class LoginConfirmPin extends StatefulWidget {
  static const kRouteName = '/LoginConfirmPin';
  final String pin;
  const LoginConfirmPin({@required this.pin});
  @override
  _LoginConfirmPinState createState() => _LoginConfirmPinState();
}

class _LoginConfirmPinState extends State<LoginConfirmPin> {
  var onTapRecognizer;
  ...
  void onConfirm(
    ...
    if (currentText != widget.pin) {
      errorController.add(ErrorAnimationType.shake);
    } else {
      appBloc.setPin(currentText);
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: WideButton(
                  ...
                  circularRadius: 0,
                  onPressed: () =>
                      onConfirm(context, formKey, currentText, errorController),
                ),
              ),
            ],
          ),
